...
const u16 gMetatiles_CitrusOutdoor[] = INCBIN_U16("data/tilesets/primary/citrus_outdoor/metatiles.bin");
const u16 gMetatileAttributes_CitrusOutdoor[] = INCBIN_U16("data/tilesets/primary/citrus_outdoor/metatile_attributes.bin");

const u16 gMetatiles_CitrusOutdoor2[] = INCBIN_U16("data/tilesets/secondary/citrus_outdoor_2/metatiles.bin");
const u16 gMetatileAttributes_CitrusOutdoor2[] = INCBIN_U16("data/tilesets/secondary/citrus_outdoor_2/metatile_attributes.bin");
